...
// ============================================================================
// Create League Page - Data-First Flow
// ============================================================================
...
export default function CreateLeaguePage() {
  ...
  // Recommend tier when form data changes
  React.useEffect(() => {
    ...
    if (rec && !selectedTierId) {
      setSelectedTierId(rec.tier_id);
    }
  }, [duration, formData.num_teams, formData.max_participants, tiers, selectedTierId]);
        ...
        <div className="grid gap-6 lg:grid-cols-3">
          ...
          <div className="lg:col-span-2 space-y-6">
            <LeagueFormSection
              ...
              maxDuration={selectedTier?.max_days || 365}
              error={error}
            />
          </div>
            ...
            {recommendation && selectedTier && (
              <>
                <TierRecommendationCard
                  ...
                  onChangeTier={() => setSelectedTierId(null)}
                />
