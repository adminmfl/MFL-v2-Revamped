...
interface FinancialSectionCardsProps {
  stats?: FinancialStatCard[];
}

// ============================================================================
// Default Financial Stats
// ============================================================================

const defaultFinancialStats: FinancialStatCard[] = [
  {
    title: "Total Revenue",
    value: "$124,580",
    change: 15.3,
...
// ============================================================================
// FinancialSectionCards Component
// ============================================================================

export function FinancialSectionCards({ stats = defaultFinancialStats }: FinancialSectionCardsProps) {
  return (
...
export default FinancialSectionCards;
